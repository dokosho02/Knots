...
pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = -1262120208;
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        ...
        14 => wire__crate__api__simple__fetch_items_by_feed_link_async_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        15 => wire__crate__api__simple__fetch_published_at_async_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        16 => wire__crate__api__simple__finalize_processing_impl(port, ptr, rust_vec_len, data_len),
        17 => wire__crate__api__simple__get_relative_time_impl(port, ptr, rust_vec_len, data_len),
        19 => wire__crate__api__simple__init_app_impl(port, ptr, rust_vec_len, data_len),
        20 => wire__crate__api__simple__process_chunk_impl(port, ptr, rust_vec_len, data_len),
        21 => wire__crate__api__simple__update_current_feed_link_async_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
        ),
        22 => wire__crate__api__simple__update_current_item_link_async_impl(
            port,
            ptr,
            rust_vec_len,
            data_len,
